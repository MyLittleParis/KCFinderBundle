...
<script src="js/browser/joiner" type="text/javascript"></script>
<script src="js_localize?lng=<?=$this->lang ?>" type="text/javascript"></script>
...
<script src="/bundles/libkcfinder/themes/<?=$this->config['theme'] ?>/init.js" type="text/javascript"></script>
<?php ENDIF ?>
